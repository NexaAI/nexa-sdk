...
- 支持 Android **Python SDK**，支持 NPU/GPU/CPU。[Python SDK文档](https://docs.nexa.ai/nexa-sdk-android/python) 及 [Demo](bindings/android/README.md)。
