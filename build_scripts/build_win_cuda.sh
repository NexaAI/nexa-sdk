...
build_and_copy_libs "llama" "-DGGML_CUDA=ON -DBUILD_SHARED_LIBS=ON" "ggml.dll" "llama.dll" "llava_shared.dll"

# Build stable-diffusion
build_and_copy_libs "stable-diffusion" "-DSD_CUBLAS=ON -DSD_BUILD_SHARED_LIBS=ON" "stable-diffusion.dll"