 ...
 */
class IndexedImagesFragment : Fragment(R.layout.fragment_indexed_images) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvImages.adapter = SelectImagesAdapter()
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment IndexedImagesFragment.
         */
