...
from nexa.eval.evaluator import request_caching_arg_to_dict
...
def cli_evaluate(args: Union[argparse.Namespace, None] = None) -> None:
    ...
    if args.trust_remote_code:
        ...
        # script--`datasets` gets imported by nexa.eval internally before these lines can update the env.
        import datasets
