...
#         logging.debug(
#             f"Loading model from {self.downloaded_path} and {self.projector_downloaded_path}"
#         )
#         try:
...
#                     self.context, ctypes.byref(self.ctx_params), self.is_qwen
#                 )
...
#         """
#         if self.context:
#             nexa_audio_lm_cpp.free_context(self.context, self.is_qwen)
